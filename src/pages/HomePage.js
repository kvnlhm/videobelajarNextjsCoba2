          ...
          {course.instructorImage && course.instructorImage.trim() !== '' ? (
            <img 
              ...
              onError={(e) => {
                ...
                e.target.className = 'w-8 h-8 rounded-full mr-2';
              }}
            />
          ) : (
            <img 
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center items-center gap-4 mb-4">
              <div className="bg-videobelajar-green text-white px-4 py-2 rounded-full">
                <span className="font-semibold">{courses.length}</span> Kelas Tersedia
              </div>
              <Link to="/produk-kelas" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition-colors">
                Lihat Semua Kelas
              </Link>
              <Link to="/crud" className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-full transition-colors ml-2">
                Kelola Kelas
              </Link>
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">Belum ada kelas yang tersedia</p>
              <p className="text-gray-400 mt-2">Tambahkan kelas baru melalui halaman CRUD</p>
            </div>
          ) : (
